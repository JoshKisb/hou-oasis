      ...
      <div className="container mx-auto px-4">
        ...
        <section className="mb-16">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-houg-primary">Our Story</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
              <div>
                <p className="text-lg mb-4">
                  Hands On Unemployment Uganda (HOUU) was founded in 2015 by a group of passionate young Ugandans who recognized the growing challenge of unemployment in their communities. With a shared vision of creating sustainable solutions to address this issue, they started grassroots initiatives focusing on skill development, environmental conservation, and community empowerment.
                </p>
                
                <p className="text-lg mb-4">
                  What began as small workshops in local communities has grown into a comprehensive organization that works across multiple districts in Uganda. Our journey has been driven by a commitment to creating lasting change and providing opportunities for marginalized communities to thrive.
                </p>
              </div>
              <div>
                <img 
            ...
            <p className="text-lg">
              Today, HOUU continues to expand its reach and impact, developing innovative programs that address the root causes of unemployment while promoting sustainable development and environmental stewardship.
            </p>
          </div>
        </section>
